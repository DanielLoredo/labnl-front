...
// WIFI CONFIG
// #define SERVER_IP "192.168.1.25:3000"
const char* ssid = "MauricioG";
const char* password = "alfredo27";
  ...
  if ((WiFi.status() == WL_CONNECTED)) {
    ...
    if (mfrc522.PICC_IsNewCardPresent()) {
      ...
      if (mfrc522.PICC_ReadCardSerial()) {
        ...
        //if (http.begin(client, "https://labnl.vercel.app/lecturaCredencial?email=A01284184@tec.mx")) {
        if (http.begin(client, "http://10.22.164.49:8000/lecturaCredencial?email=A01284184@tec.mx")) {
